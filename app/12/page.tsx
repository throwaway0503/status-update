...
const CurrentContent: React.FC = () => {
    ...
    return (<>
        ...
        <p>
            En este tiempo en el que tuve amigos de universidad que se referían a mí exclusivamente como 'Alejandro' pensé tal vez que me acostumbraría, y la verdad que aun me parece un nombre ajeno a mí... no siento que soy yo realmente. Hasta me sentía más identificado con mi nombre de usuario que con Alejandro, así que eso dice algo definitivamente XD
        </p>
        <p>
        ...
        <p>
            Pero bueno, no estoy exigiendo que ahora me digan así. También voy por 'Oré' o 'Jano' (y 'Alejandro' por tecnicidad, pero prefereiblemente no xd); así que en teoría no debería de haber ningún cambio para ustedes (porque imagina llamarme Alejandro XD), y entonces solo les estaba contando sobre esta decisión que tomé.
        </p>
        <p>
