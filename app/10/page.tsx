...
const CurrentContent: React.FC = () => {
    return (<>
        ...
        <p>
            Y bueno, tras pensar por buen rato en un nuevo nombre de usuario que sentí que me representaría mejor, acabé llegando a este. Quiero que se sienta familiar, pero distinto; básicamente lo mismo que estoy haciendo con este 'nuevo inicio' en general.
        </p>
        <p>
            La inspiración claramente es lo contrario. Anteriormente era 'Luna Oscura'. Ahora decidí que sea similar. No descartemos la
            <> </>
