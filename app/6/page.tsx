...
const CurrentContent: React.FC = () => {
    ...
    <p>
        Gracias a ella aprendí mucho sobre mí, y es gracias a ella que estoy donde estoy, para bien o para mal; y no lo querría de otra manera. Si bien siento que sufrí mucho por toda esta cosa, es gracias a esto que estoy saliendo adelante como ser humano en múltiples formas, y por ello estoy eternamente agradecido.
    </p>
    <p>
        Gracias a ella aprendí bastante de mis fallas como persona, y por ello recibí apoyo incluso cuando no pensé que lo necesitaba. Incluso luego de habernos separado por completo, sigo aprendiendo mucho de como vivir, de como pensar de una forma más abierta (aunque no lo crean XD), y de como ser yo.
    </p>
    <p>
