...
const CurrentContent: React.FC = () => {
    return (<>
        ...
        <p>
            Pues luego de haberlo reconsiderado desde entonces, preferiría que cualquier cosa se le conozca como "cyan", porque ese es el nombre de usuario que usaba cuando hablabamos constantemente; cuando la llamé mi 'mejor amiga'. Es por ello que en todo caso me gustaría que se le recuerde más con ese nombre, en lugar de recordarla con el nombre que llevaba cuando empezamos a tener problemas por así decirlo.
        </p>
        <img src="cyan.png"/>
        <p>
