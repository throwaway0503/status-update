...
const CurrentContent: React.FC = () => {
    ...
    return (<>
        ...
        <p>
            Pero no me comprometí a ello. No empecé desde cero realmente. Seguía pegado al pasado en múltiples formas. ¿Pero ahora? No podría decir con certeza absoluta que ahora sí es el caso, pero si una cosa he aprendido, es que nunca se sabe si estarás listo... Solo es un salto de fe (aguante spiderverse XD)
        </p>
        <p>
