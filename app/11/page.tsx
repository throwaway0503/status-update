...
const CurrentContent: React.FC = () => {
    return (<>
        ...
        <p>
            También cabe destacar que esto no significa nada fuera de una identidad. No es una orientación romántica / sexual. Aun me gustan las mujeres y no me gustan los hombres (sorprendente, lo sé XD)
        </p>
        <p>
        ...
        <p>
            Pese a que sea experimental, llevo con esta idea de mi identidad desde ya más de 3 meses. Al inicio empezó sólo como una idea que entró a mi mente (como muchas de las que se me ocurren, y luego se van). Después de darle unas cuantas vueltas en mi mente, decidí por lo menos tenerlo en cuenta cuando explore más sobre mi identidad. Quizás sólo es un pensamiento pasajero, y eventualmente dejaré de sentirme así... ¿verdad?
        </p>
        <p>
