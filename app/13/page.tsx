...
const CurrentContent: React.FC = () => {
    return (<>
        ...
        <p>
            Para describir a este personaje que he establecido a ustedes: este es uno que no le importa como se ve, ni le presta atención a este tipo de cosas; llamese apariencia física, llamese estilo de ropa, llamese estilo de pelo, etc. Si bien este personaje inicialmente se forma porque refleja un aspecto de mis creencias, resulta que con el paso del tiempo lo que quiero conmigo mismo se desalinea con aquello que he establecido en para mi personaje.
        </p>
        <p>
            Me cuesta mucho hacer esto, pero estoy tomando pasos para romper este personaje. No sólo eso, sino que estoy tomando un esfuerzo para mostrar una versión de mí que sea más honesta en general a lo que soy como persona actualmente. Así que si bien no estoy haciendo cambios tan drásticos aun, el hecho es que estoy tomando un paso para romper esto, y eso es un gran avance.
        </p>
        <p>
